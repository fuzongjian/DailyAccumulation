...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self configAnimationControllerUI];
}
- (void)configAnimationControllerUI{
...
- (NSArray *)dataArray{
    if (_dataArray == nil) {
        _dataArray = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"animation" ofType:@"plist"]];
    }
    return _dataArray;
}
